...
✅ PRICING ARCHITECTURE:
   Strict Single Source of Truth (SSOT). All pricing variables 
   have been removed from here. Pricing strictly comes from the 
   Database (pricing_config table).
"""
import os
from typing import List

# Pydantic imports safely separated to avoid mobile IDE line break errors
...
class Settings(BaseSettings):
    ...
    def require_keys_in_production(cls, v: str, info: ValidationInfo) -> str:
        ...
        if app_env != "development" and not v:
            msg = f"{info.field_name} is required in production"
