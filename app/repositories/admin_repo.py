...
from app.utils.timestamp import ts_to_iso # ✅ Added SSOT Helper
...
class AsyncAdminRepository:
    ...
    async def get_dashboard_stats(self) -> Dict[str, Any]:
        ...
        # ✅ Define individual async tasks with local client fetches for safety
