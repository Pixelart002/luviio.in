...
class OrderRepository(BaseRepository):
     ...
     def get_shipping_address(self, address_id: str, user_id: str) -> dict[str, Any] | None:
     ...
     def get_user_orders(self, user_id: str, status_filter: str | None, page: int, page_size: int) -> tuple[list, int]:
     ...
     def get_all_orders(self, status_filter: str | None, page: int, page_size: int) -> tuple[list, int]:
        offset = (page - 1) * page_size
     ...
     def get_order_for_admin_update(self, order_id: str) -> dict[str, Any] | None:
