...
_DB_CHECK_RETRIES = 3
_DB_CHECK_RETRY_DELAY = 1.0  # seconds between retries
...
async def health_check() -> dict:
    ...
    Retries up to 3 times with 1s backoff to avoid false positives from
    transient network timeouts (e.g. Cloudflare 522 errors).
    """
    ...
    for attempt in range(1, _DB_CHECK_RETRIES + 1):
        try:
            ...
            last_exc = exc
            # Classify error type for richer response detail
