...
from app.api.schemas.cart_dto import AddItemRequest, UpdateItemRequest
...
@router.get("/admin/abandoned", dependencies=[Depends(require_permission(AdminPermissions.VIEW_ANALYTICS))])
...
@router.post("/admin/remind/{cart_id}", dependencies=[Depends(require_permission(AdminPermissions.MANAGE_SETTINGS))])
