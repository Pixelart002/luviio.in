-- Fix PostgREST RPC overload ambiguity for cancel_order_and_release_stock.
-- Keep the two-argument compatibility wrapper, but make the authoritative
-- three-argument function require p_target_status explicitly. Without a
-- default, a two-argument RPC call resolves only to the two-argument wrapper.
