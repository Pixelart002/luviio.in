...
-- settle_order_transaction: locks the order row, checks idempotency, marks it
-- paid and records the payment in a single atomic operation.
-- Note: orders are filtered by `customer_id` (the actual FK), not `user_id`.
