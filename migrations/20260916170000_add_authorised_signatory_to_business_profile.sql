...
values
  ('business_authorised_signatory_name', 'general', 'string', '""'::jsonb, '""'::jsonb, 'Authorised signatory name printed on issued business documents.', false, false),
  ('business_authorised_signatory_designation', 'general', 'string', '""'::jsonb, '""'::jsonb, 'Authorised signatory designation printed on issued business documents.', false, false)
